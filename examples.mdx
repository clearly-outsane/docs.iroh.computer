...
<Columns cols={2}>
  ...
  <Card
    title="hello-iroh-ffi"
    icon="mobile"
    href="https://github.com/n0-computer/hello-iroh-ffi"
  >
...
<Columns cols={2}>
  <Card
    title="Hubris"
    icon="notebook-pen"
    href="https://clearly-outsane.yard.sh/hubris/"
  >
    Hubris is an collaborative workspace for visual thinkers, with a note first approach. No subscriptions, no limits.
  </Card>
  <Card
    title="alt sendme"
    icon="paper-plane"
